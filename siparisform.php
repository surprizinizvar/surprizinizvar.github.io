...
$subject="Surpriziniz Var! - 1 Aylık Surpriz Kutusu Siparisiniz";

$message = "Merhaba ".$adsoyad.",";
$message .= "\n\n";
$message .= "Sürpriz kutu siparişinizi aldık. Teşekkür ederiz ! Aşağıdaki belirtilen banka hesabına 24 saat içerisinde 39.90 TL havale yaptıktan sonra siparişiniz kesinleşecektir. Lütfen havalenizde gönderen kişi ya da bilgilendirme kısmında kendi isminizin olmasına dikkat ediniz.";
$message .= "\n\n";
